...
*MY ANSWER*: rpk version v23.2.26 (rev 328d83a06e)
...
*MY ANSWER*: Took 0.51 seconds, most of which was spent sending the messages.
...
*MY ANSWER*: Took about 63 seconds
...
*MY ANSWER*: Destination with DOLocationID 74 is most popular.
```
+------------+------------------------------------------+-----+
